    ...
    <div class="px-4 sm:px-6 lg:px-8 mt-20 w-1/3 mx-auto">
        <div class="sm:flex sm:items-center">
            <div class="sm:flex-auto">
                <h1 class="text-xl font-semibold text-gray-900">{{ __('texts.quotes') }}</h1>
            </div>
            <x-search-bar />
            <div class="mt-4 sm:mt-0 sm:ml-16 sm:flex-none">
                <button type="button"
                    ...
                    <a href="/admin/quotes/create">{{ __('texts.add_quote') }}</a></button>
            </div>
        </div>
                            ...
                            <thead class="bg-gray-50">
                                <tr>
                                    ...
                                    <th scope="col" class="relative py-3.5 pl-3 pr-4 sm:pr-6">
                                        <span class="sr-only">{{ __('texts.edit') }}</span>
                                    </th>
                                    <th scope="col" class="relative py-3.5 pl-3 pr-4 sm:pr-6">
                                        <span class="sr-only">{{ __('texts.delete') }}</span>
                                    </th>
                                </tr>
                            </thead>
